		...
		<form action="" class="form-regist-1">
			<div class="row">
				<div class="col-sm-5 col-sm-offset-1">
					<input type="text" id="input-companyname" class="form-control" placeholder="Название организации">
				</div>
				<div class="col-sm-5">
			...
			<p class="text-center help-block"><i class="fa fa-exclamation-circle pink" aria-hidden="true"></i> <i>все поля обязательны для заполнения</i></p>
			<br/>
			<br/>
